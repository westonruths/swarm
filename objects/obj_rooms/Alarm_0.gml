...
with (obj_wall) {
	array_push(other.tmp_cells, instance_position(x-global.grid_resolution, y-global.grid_resolution, obj_cell))
	array_push(other.tmp_cells, instance_position(x-global.grid_resolution, y, obj_cell))
	array_push(other.tmp_cells, instance_position(x-global.grid_resolution, y+global.grid_resolution, obj_cell))
	array_push(other.tmp_cells, instance_position(x+global.grid_resolution, y-global.grid_resolution, obj_cell))
	array_push(other.tmp_cells, instance_position(x+global.grid_resolution, y, obj_cell))
	array_push(other.tmp_cells, instance_position(x+global.grid_resolution, y+global.grid_resolution, obj_cell))
	array_push(other.tmp_cells, instance_position(x, y-global.grid_resolution, obj_cell))
	array_push(other.tmp_cells, instance_position(x, y+global.grid_resolution, obj_cell))
}
...
//with (obj_mtn_wall) {
//	if sprite_index == gw_middle_center { continue }
//	array_push(other.tmp_cells, instance_position(x-global.grid_resolution, y-global.grid_resolution, obj_cell))
//	array_push(other.tmp_cells, instance_position(x-global.grid_resolution, y, obj_cell))
//	array_push(other.tmp_cells, instance_position(x-global.grid_resolution, y+global.grid_resolution, obj_cell))
//	array_push(other.tmp_cells, instance_position(x+global.grid_resolution, y-global.grid_resolution, obj_cell))
